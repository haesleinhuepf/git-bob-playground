...
class ImageScatter(Scatter):
    """Widget for handling draggable/scalable/rotatable images"""
...
class TouchApp(App):
    ...
    def build(self):
        ...
        buttons = ['Load', 'Save', 'Delete', 'Move', 'Select']
        for text in buttons:
        ...
        self.transforms = pd.DataFrame(
            columns=['x', 'y', 'rotation', 'scale', 'selected']
        )
        ...
        for i, img in enumerate([img1, img2]):
            ...
            self.transforms.loc[i] = [0, 0, 0, 1, 0]
